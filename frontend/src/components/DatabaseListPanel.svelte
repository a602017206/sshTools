<script>
  ...
  function handleTableClick(tableName) {
    // Single click: show table structure (DDL)
  ...
  function handleTableDoubleClick(tableName) {
    // Double click: open table data panel
            ...
            <tbody>
              {#each sortedTableMeta as meta}
                <tr
                  ...
                  on:click={() => handleTableClick(meta.tableName)}
                  on:dblclick={() => handleTableDoubleClick(meta.tableName)}
                >
