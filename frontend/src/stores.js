...
export const tableStructureStore = writable({
  isOpen: false,
  sessionId: null,
  databaseName: '',
  schemaName: '',
...
export function showTableStructure({ sessionId, databaseName, schemaName = '', tableName, dbConfig, mode = 'design' }) {
...
export function hideTableStructure() {
  tableStructureStore.update($state => ({ ...$state, isOpen: false }));
}
