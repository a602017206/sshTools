...
// NewFallbackConfigManager creates a non-persistent in-memory config manager
// used when the disk-based config manager cannot be initialized
func NewFallbackConfigManager() *ConfigManager {
